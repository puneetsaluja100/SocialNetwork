...
public class coversation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        send_conversation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                coversation.MysqlCon mysqlCon= new coversation.MysqlCon();
    ...
    private void prepareconversationData() {
        ...
        if (conversationList.size() == 0) {
            ...
            MysqlConConversationShow mysqlConConversationShow = new coversation.MysqlConConversationShow();
            mysqlConConversationShow.execute("getConversation", String.valueOf(Uid), String.valueOf(Sid));
        } else {
